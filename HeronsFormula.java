...
public class HeronsFormula
{
	public static void main( String[] args )
	{
		...
		//It was easier to do so in the code with a function
	}
...
// 2. 30 lines-HeronsFormula.java and 50 lines-HeronsFormulaNoFunction.java

// 3. It was easier fixing the one that uses a function
